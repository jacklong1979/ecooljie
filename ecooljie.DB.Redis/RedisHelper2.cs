...
namespace ecooljie.DB.Redis
{
    ...
    {
        public static RedisHelper2 Instance
        {
            get
            {               
                return new RedisHelper2();
            }
        }
        ...
        public RedisHelper2(int dbNum = 0)
                : this(dbNum, null)
        {
        }

        public RedisHelper2(int dbNum, string readWriteHosts)
        {
            DbNum = dbNum;
            _conn =
